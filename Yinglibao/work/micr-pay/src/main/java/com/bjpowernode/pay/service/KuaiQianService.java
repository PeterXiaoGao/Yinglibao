...
public class KuaiQianService {
    ...
    public Map<String, String> generateFormDate(Integer uid, String phone, BigDecimal rechargeMoney) {
        ...
        String bgUrl = "https://7w87138a49.goho.co/pay/kq/rece/notify";
        // 网关版本，固定值：v2.0,该参数必填。
        String version = "v2.0";
        ...
        try {
            ...
            if (StringUtils.isNotBlank(response)) {
                ...
                if (detailObject != null) {
                    ...
                    JSONObject listJsonObject = array.getJSONObject(0);
                    if (listJsonObject != null) {
                        // 处理充值结果，和异步通知一样
                        int result = rechargeService.handlerKQNotify(listJsonObject.getString("orderId"),
                                listJsonObject.getString("payAmount"),
                                listJsonObject.getString("payResult"));
