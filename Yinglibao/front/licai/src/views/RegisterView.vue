          ...
          <form action="" id="register_Submit">
            <div class="alert-input">
              ...
              <input type="password" placeholder="请输入6-20位英文和数字混合密码"
                     class="form-border user-pass" v-model="password" @blur="checkPassword" autocomplete
                     name="password">
      ...
      if (this.phoneErr === '' && this.passwordErr === '' && this.codeErr === '') {
        if (this.agree) {
          ...
          doPost('/v1/user/register', {
            ...
            layx.msg("响应失败", {dialogIcon: 'error', position: 'ct'});
            console.log(error);
          })
        }else{
